...
\textbf{\underline{Simulação 1.1}: $\theta(0)$}
%
\begin{align*}
...
\textbf{\underline{Simulação 1.2}: $y(0)$}
%
\begin{align*}
  y &= \frac{5}{s^2+2s+1}u\,,  &  \theta(0) &= 0 \,,
  & y(0) &=  \HI{0} \, \textrm{e} \, \HI{5} \,, & \Gamma &= 1 \, \textbf{I}_3\,,
  \\ y_r &= \textrm{sin}(t) + \textrm{sin}(3t) \, .
\end{align*}
...
Verificamos o comportamento do sistema para variações no parâmetro de adaptação
$\Gamma$.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm]{figs/e0/sim0_gamma1gamma10.eps} 
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=12cm]{figs/modtheta/sim0_gamma1gamma10.eps} 
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=12cm]{figs/tiltheta/sim0_gamma1gamma10.eps} 
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=12cm]{figs/y/sim0_gamma1gamma10.eps} 
\end{figure}
...
\textbf{\underline{Simulação 3.1}: planta}
%
\begin{align*}
...
\textbf{\underline{Simulação 3.2}: modelo}
%
\begin{align*}
