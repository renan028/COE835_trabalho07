...
condições iniciais.
%
Para todas as simulações, utilizamos $k^\intercal = \mat{1 & 1}$, $c_1 = c_2 = d_1 = d_2 = \gamma = 1$ e condições iniciais nulas em todas as dinâmicas, exceto em $y(0)$.
...
Verificamos o comportamento do sistema para variações nos parâmetros da planta.
...
Verificamos o comportamento do sistema para variações no sinal de referência $y_r(t)$.
...
Verificamos o comportamento do sistema para variações no ganho de adaptação $\Gamma$.
