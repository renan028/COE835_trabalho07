...
elaboração do método é começar pela primeira equação \ref{eq:planta},
...
$\theta$. Consideremos a fun;áo de Lyapunov:
...
\left(\dot{\tilde{p}}-\text{sign}(k_p)\gamma\bar{u}z_2\right)
\label{eq:dotV2}
\end{align}
...
\frac{\partial\alpha_1}{\partial x_1}\phi_1) + \frac{\partial\alpha_1}{\partial
x_1}x_2 + \frac{\partial\alpha_1}{\partial \hat{\theta}}\hat{\theta} +
...
\tilde{\theta}^\intercal(\tau_2-\Gamma^{-1}\dot{\hat{\theta}}) + \frac{|k_p|}{\gamma}\tilde{p} \,
\left(\dot{\tilde{p}}-\text{sign}(k_p)\gamma\bar{u}z_2\right)
\end{align}
