...
Porém, este estimador não pode ser estimado, pois $\theta$ não é conhecido. A
dinâmico do observador pode ser descrita como:
...
onde $\rho$ é estimativa de $\frac{1}{k_p}$
